...
void renderer_draw_triangle(uint32_t tile_x, uint32_t tile_y, Triangle tri)
{
    ...
    {
        pos1 = v2i((int)tri.vertices[0].x, (int)tri.vertices[0].y);
        pos2 = v2i((int)tri.vertices[1].x, (int)tri.vertices[1].y);
        pos3 = v2i((int)tri.vertices[2].x, (int)tri.vertices[2].y);
    }
...
void draw_texture(Texture *tex, Reci rec)
{
    float x0 = rec.x;
    float y0 = rec.y;
    float x1 = rec.x + rec.w;
    float y1 = rec.y + rec.h;
